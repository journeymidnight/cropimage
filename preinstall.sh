  ...
  if [ -f /etc/debian_version ]; then
    ...
    case $RELEASE in
      "Red Hat Enterprise Linux release 7."*|"CentOS Linux release 7."*|"Scientific Linux release 7."*)
        ...
        yum install -y tar curl libpng-devel libjpeg-devel libxml2-devel zlib-devel pango-devel openjpeg-devel libtiff-devel gdk-pixbuf2-devel sqlite-devel cairo-devel glib2-devel
...
if [ -f /etc/debian_version ]; then
  ...
  case $RELEASE in
    "Red Hat Enterprise Linux release 7."*|"CentOS Linux release 7."*|"Scientific Linux release 7."*)
      ...
      yum groupinstall -y "Development Tools"
      yum install -y tar curl gtk-doc libxml2-devel libjpeg-turbo-devel libpng-devel libtiff-devel libexif-devel libgsf-devel lcms2-devel gobject-introspection-devel libwebp-devel
    ...
    "Red Hat Enterprise Linux release 6."*|"CentOS release 6."*|"Scientific Linux release 6."*)
      ...
      echo "Installing libvips dependencies via yum"
      yum groupinstall -y "Development Tools"
      yum install -y tar curl gtk-doc libxml2-devel libjpeg-turbo-devel libpng-devel libtiff-devel libexif-devel libgsf-devel lcms-devel
